...
fitting source activity.  In the next step, our PyTorch implementation refines wind and
dispersion under explicit constraints.  Let \(\phi\) denote the wind-imputer parameters and let \(\psi\) denote the
...
physically admissible dispersion-parameter set. The prospective
