...
Building on the projected inverse problem of
Section~\ref{sec:problem_setup}, we now describe how the response matrix is
constructed in practice and how source activities are estimated from it.
...
trained a learned coordinate-query model but did not adopt it, because it did not
improve held-out accuracy over a city-mean baseline
