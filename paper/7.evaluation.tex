...
of proxy inventories, and ask whether the geometry of \(\widetilde H_\Phi\) predicts
which coefficient, activity, and grouped-source claims are defensible.  A shared base configuration is varied along one controlled
